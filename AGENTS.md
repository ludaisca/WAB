...
|---|---|---|
| `admin` | everything: Panel, Estadísticas, Chats, Contactos, Bots IA, Calificadores, Conocimiento, Cuentas, Plantillas, Campañas, Usuarios, Config | none |
| `user` | like admin **minus** Contactos, Bots IA, Base de Conocimiento, Usuarios | `USER_BLOCKED`: `/whatsapp/contactos`, `/whatsapp/bots`, `/whatsapp/conocimiento`, `/configuracion/ia` |
| `ejecutivo` | Chats, Contactos, Config | `EXECUTIVE_BLOCKED`: `/dashboard`, `/estadisticas`, `/usuarios`, `/whatsapp/{bots,conocimiento,campanas,plantillas,cuentas}`, `/configuracion/ia` |
