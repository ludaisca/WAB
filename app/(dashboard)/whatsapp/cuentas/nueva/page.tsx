    ...
    <div className="space-y-6 max-w-2xl">
      <div>
        ...
        <p className="mt-1 text-sm text-muted">
          Conecta un número de WhatsApp usando la API oficial de Meta Cloud.
        </p>
      </div>
        ...
        <form onSubmit={handleSubmit}>
          <CardBody>
            <div className="space-y-5">
              ...
              <FormField label="Verify Token" required error={errors.verifyToken} hint="Token que Meta usará para verificar el webhook. Copia este mismo valor en la configuración del webhook de tu App de Meta.">
                {(id) => (
                  <Input
                    id={id}
                    value={verifyToken}
          ...
          <CardFooter>
            ...
            <Button href="/whatsapp/cuentas" type="button" variant="secondary">
              Cancelar
            </Button>
          </CardFooter>
        </form>
